...
The closed control uses Frasto tokens across its full interactive area. The opened option menu remains native: its width, row hit area, spacing, and some colors are controlled by the operating system and browser. A custom listbox Select is planned as a separate post-alpha accessibility milestone.
