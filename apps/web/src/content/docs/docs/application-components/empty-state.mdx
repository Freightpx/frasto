...
import { Button, EmptyState, FileTextIcon, Icon } from '@freightpx/frasto';
...
- Keep title and description as plain strings so heading structure and readable measure remain predictable.
- Preserve authored action order and native control behavior.
- Hide the optional icon wrapper from assistive technology.
- Preserve consumer classes and native root attributes.
